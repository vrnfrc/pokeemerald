...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KADABRA,
    .moves = {MOVE_HIDDEN_POWER, MOVE_RECOVER, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 130,
    .lvl = 25,
    .species = SPECIES_KIRLIA,
    .moves = {MOVE_CALM_MIND, MOVE_CONFUSION, MOVE_HIDDEN_POWER, MOVE_GROWL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jaclyn[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KIRLIA,
    .moves = {MOVE_CONFUSION, MOVE_HIDDEN_POWER, MOVE_CALM_MIND, MOVE_GROWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_STOMP, MOVE_FURY_ATTACK, MOVE_HORN_ATTACK, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 17,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ASTONISH, MOVE_ACID, MOVE_CONSTRICT, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 17,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUD_SPORT, MOVE_HARDEN, MOVE_SCRATCH, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 18,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TACKLE, MOVE_ENDURE, MOVE_LEER, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 23,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PECK, MOVE_EMBER, MOVE_DOUBLE_KICK, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEAF_BLADE, MOVE_PURSUIT, MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 32,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPARK, MOVE_SONIC_BOOM, MOVE_SHOCK_WAVE, MOVE_SUPERSONIC}
    },
    {
    .iv = 255,
    .lvl = 33,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_SHOCK_WAVE, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SELF_DESTRUCT, MOVE_SCREECH, MOVE_SHOCK_WAVE, MOVE_SPARK}
    },
    {
    .iv = 255,
    .lvl = 34,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_CONFUSION, MOVE_OVERHEAT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_FLAMETHROWER, MOVE_ROCK_THROW, MOVE_AMNESIA}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_BLAZE_KICK, MOVE_DOUBLE_KICK, MOVE_SCRATCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCRATCH, MOVE_HEADBUTT, MOVE_FACADE, MOVE_ODOR_SLEUTH}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_TEETER_DANCE, MOVE_DIZZY_PUNCH, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ATTRACT, MOVE_SING, MOVE_FACADE, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCRATCH, MOVE_PURSUIT, MOVE_SWORDS_DANCE, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_BEAM, MOVE_FACADE, MOVE_SCREECH, MOVE_UPROAR}
    },
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLACK_OFF, MOVE_FACADE, MOVE_YAWN, MOVE_COUNTER}
    }
};
